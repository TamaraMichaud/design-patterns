...
// we want String to have a getter which tells us the number of vowels present
// we cannot simply extends String -> string is a final class.

// string has a very rich api, so we want to alt+insert->Delegate Methods...
// we make our magicString class behave like the object we've decorated
...
public class bStringDecorator {
    public static void main(String[] args) {
        MagicString hello = new MagicString("hello");
        System.out.println("Hello has " + hello.numberOfVowels() + " vowels");
    }
}


// we have here delegated all methods of string...
// and we also want to add our own!
